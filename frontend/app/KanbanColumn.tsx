...
export default function KanbanColumn(props : { colNum : any, cardCount : MutableRefObject<number>, colCount : MutableRefObject<number>, ws : WebSocket, conversationRef : any, onCardActivate : any}) {
  type Card = {
    id : number,
    name: string,
    col : number
